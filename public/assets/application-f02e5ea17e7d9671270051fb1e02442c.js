...
function loading(){
    ...
    document.getElementById("dropdown_cases_").style.display="none";
    document.getElementById("getting_song").style.paddingTop="0px";
    return false;
}

function change_red(){
    document.getElementById("next-arrow").style.display="none";
    document.getElementById("next-song-text").style.display="inline";

    document.getElementById("next-song-text").style.marginTop="15px";
    document.getElementById("next-song-text").style.marginBottom="7px";
    document.getElementById("next-button").style.paddingTop="0px";

    document.getElementById("next-song-text").style.marginRight="-3px";
    document.getElementById("next-song-text").style.marginLeft="11px";
    document.getElementById("next-button").style.paddingLeft="0px";
    return false;
}

function change_white(){
    document.getElementById("next-song-text").style.display="none";
    document.getElementById("next-arrow").style.display="block";

    document.getElementById("next-song-text").style.marginTop="0px";
    document.getElementById("next-song-text").style.marginBottom="0px";
    document.getElementById("next-button").style.paddingTop="15px";

    document.getElementById("next-song-text").style.marginRight="0px";
    document.getElementById("next-song-text").style.marginLeft="0px";
    document.getElementById("next-button").style.paddingLeft="15px";
    return false;
}
