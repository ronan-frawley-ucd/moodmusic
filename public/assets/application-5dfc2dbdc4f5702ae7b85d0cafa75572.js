...
function loading(){
    ...
    document.getElementById("song").style.width="0px";
    document.getElementById("song").style.height="0px";
    document.getElementById("loading_gif").style.width="auto";
    document.getElementById("loading_gif").style.visibility="visible";
    document.getElementById("dropdown_cases_").style.width="0px";
    document.getElementById("dropdown_cases_").style.visibility="hidden";
